...
class EMIInfo extends React.Component<IEMIInfodProps, IEMIInfoState> {
  ...
  spListService = new SPListService(
  ...
  saveEMIInfoData = async () => {
    if (this._isValid()) {
      ...
      let emiMetaData = {
        ...
        RemainingFees:
          this.props.courseInfoData.totalFees - this.state.formValues.feesPaid,
      ...
      await this.spListService.UpdateListItemByID(
        this.props.basicInfoData.spStudentId,
        emiMetaData,
        "StudentRegistrations"
      );

      let spEmiItems = await this.spListService.GetListItems(
        "EMIMaster",
        "Id,StudentItemId/Id",
        `StudentItemId/Id eq ${this.props.basicInfoData.spStudentId}`,
        "StudentItemId/Id"
      );
      ...
      this.setState(
        {
          ...
          formValues: {
            ...
            initialAmount: emiCalState?.initialAmount
              ? emiCalState.initialAmount
              : 0,
  ...
  private _isValid = () => {
    if (
      this.validationSerive.isNumberFieldEmpty(
        this.state.formValues.feesPaid
      ) ||
      this.validationSerive.isNumberFieldEmpty(
        this.props.courseInfoData.totalFees
      ) ||
                ...
                <TextField
                  ...
                  errorMessage={
                    ...
                    this.validationSerive.isNumberFieldEmpty(
                      ...
                      ? "Total fees is required.Select courses from step 2"
                      : ""
                  }
                />
              </Col>
                  ...
                  errorMessage={
                    ...
                    this.validationSerive.isNumberFieldEmpty(
                      ...
                      : this.state.notFormValid &&
                        this.state.formValues.feesPaid >
                          this.props.courseInfoData.totalFees
                      ? "Fees paid should not be greater than total fees"
                      : ""
                  }
                />
              </Col>
            ...
            <Row>
              ...
              !this.state.formValues.isPayInEMI ? (
                <label className="error-message">
                  Please pay the total fees or select the pay in EMI option
                </label>
              ) : (
                ""
              )}
